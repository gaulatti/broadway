...
assert.equal(
  modoItalianoGiorgiaDefinition.durationInFrames /
    modoItalianoGiorgiaDefinition.fps,
  15,
);
...
assert.throws(
  () =>
    assertModoItalianoGiorgiaInput({ ...fixture, headline: "x".repeat(53) }),
...
await assert.rejects(
  assertInputAssets(
    { ...fixture, audioAsset: "missing.mp3" },
